...
<body class="w3-theme-l2">
    ...
    <i id="visible" onclick="hideshow(this.id1)" class='fa fa-eye'></i>
            ...
            <label>Gender:</label>
            <div id="radio" style="height: 1cm;">
                <table border="0">
                    <tr>
                        <td>
                            Male
                            <input type="radio" name="sex" value="Male" required style="height: 0.4cm;" />
                        </td>
                        <td>
                            Female
                            <input type="radio" name="sex" value="Female" required style="height: 0.4cm;" />
                        </td>
                    </tr>
                </table>
            ...
            <div class="btm">
                ...
                <p class="formText" style="margin-left: 5cm;margin-top: -0.5cm;">
