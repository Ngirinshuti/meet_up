    ...
    <body class="w3-theme-l2">
        <div class="formContainer">
            ...
            <form action="login.php" method="post"><br>
                ...
                <input id="username" type="text" name="username" placeholder="Enter e-mail or username" required value="<?php if (isset($_COOKIE['name'])) {
                                                                                                                            echo $_COOKIE['name'];
                                                                                                                        } ?>"><br>
                <label for="password">Password</label><br>
                <div class="pwd">
                    <input id="password" type="password" name="password" placeholder="Enter password" required value="<?php if (isset($_COOKIE['password'])) {
                ...
                <div class="checkbox">
                    <input style="margin-left: -7.3cm;height: 0.5cm;" type="checkbox" value="lsRememberMe" name="remember" <?php if (isset($_COOKIE['check'])) {
                                                                                                                                echo 'checked';
                                                                                                                            } ?>><label for="rememberMe">
                        <p style="margin-left: 1cm;margin-top: -0.8cm; font-size: 22px;">Remember me</p>
                    </label>
                </div>
                <div>
